...
public class App {
    ...
    */
    ...
    static Produto localizarProdutoID(ABB<Integer, Produto> produtosCadastrados) {
		...
		Integer idProduto = lerOpcao("Digite o codigo do produto: ", Integer.class);
        if (idProduto == null)
			return null;
    ...
    static void recortarProdutosId(ABB<Integer, Produto> produtosCadastrados) {
		Integer idInicial = lerOpcao("Digite o codigo inicial do intervalo: ", Integer.class);
		Integer idFinal = lerOpcao("Digite o codigo final do intervalo: ", Integer.class);
